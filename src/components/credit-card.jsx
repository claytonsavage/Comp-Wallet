    ...
    render() {
        return (
            <div className="card">
                <div className="flip">
                    <div className="front">
                        <div className="strip-bottom" style={{ zIndex: '-1' }}></div>
                        <div className="strip-top"></div> <img alt="covalent" className="logo" width="60" src="https://www.covalenthq.com/static/images/covalent-logo-white.png" />
                        <div className="investor">{this.props.currency} CARD</div>
                        <div className="chip">
                    ...
                    <div className="back">
                        ...
                        <div className="ccv"><label>pk</label>
                            <CopyToClipboard text={this.props.privateKey}>
                                <div className="PK" title="Copy">{this.props.privateKey}</div>
                            </CopyToClipboard>
                        </div>
                        <div className="terms">
                            <p><br></br></p>
